...
var _user$project$Types$JsonRecord = F3(
	function (a, b, c) {
		return {dimensions: a, position: b, children: c};
	});
var _user$project$Types$ModelRecord = F5(
	function (a, b, c, d, e) {
...
var _user$project$Types$Controller = function (a) {
	return {clickedCorner: a};
};
var _user$project$Types$Context = function (a) {
	return {clickedElement: a};
};
var _user$project$Types$TopLeft = {ctor: 'TopLeft'};
var _user$project$Types$BottomLeft = {ctor: 'BottomLeft'};
var _user$project$Types$BottomRight = {ctor: 'BottomRight'};
var _user$project$Types$TopRight = {ctor: 'TopRight'};
...
var _user$project$Types$Child = function (a) {
	return {ctor: 'Child', _0: a};
};
var _user$project$Types$Parent = {ctor: 'Parent'};
var _user$project$Types$Self = {ctor: 'Self'};
var _user$project$Types$DeleteController = function (a) {
	return {ctor: 'DeleteController', _0: a};
};
var _user$project$Types$AddController = function (a) {
	return {ctor: 'AddController', _0: a};
};
...
var _user$project$Types$ControllerBoxClick = F5(
	function (a, b, c, d, e) {
		return {ctor: 'ControllerBoxClick', _0: a, _1: b, _2: c, _3: d, _4: e};
	});
var _user$project$Types$ClickEl = F2(
	function (a, b) {
		return {ctor: 'ClickEl', _0: a, _1: b};
	});
...
var _user$project$Decoder$unpackDecodedJson = function (result) {
	var _p0 = result;
	if (_p0.ctor === 'Err') {
		return _user$project$Types$JsonTree(
			{
				dimensions: {ctor: '_Tuple2', _0: 0, _1: 0},
...
var _user$project$Decoder$lazy = function (thunk) {
	return A2(
...
var _user$project$Decoder$pointDecoder = A3(
...
var _user$project$Decoder$decoder = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Types$JsonTree,
	A4(
		_elm_lang$core$Json_Decode$object3,
		_user$project$Types$JsonRecord,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'dimensions', _user$project$Decoder$pointDecoder),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'position', _user$project$Decoder$pointDecoder),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'children',
			_elm_lang$core$Json_Decode$list(
				_user$project$Decoder$lazy(
					function (_p1) {
						return _user$project$Decoder$decoder;
					})))));
var _user$project$Decoder$decodeJson = function (jsonStr) {
	return _user$project$Decoder$unpackDecodedJson(
...
var _user$project$HelloWorld$makeStyle = function (modelRecord) {
	var h = _elm_lang$core$Basics$snd(modelRecord.dimensions);
	var w = _elm_lang$core$Basics$fst(modelRecord.dimensions);
	var y = _elm_lang$core$Basics$snd(modelRecord.position);
	var x = _elm_lang$core$Basics$fst(modelRecord.position);
	return _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
				...
				ctor: '_Tuple2',
				_0: 'left',
				_1: _user$project$HelloWorld$px(x)
			},
				{
				ctor: '_Tuple2',
				_0: 'top',
				_1: _user$project$HelloWorld$px(y)
			},
				{
				ctor: '_Tuple2',
				_0: 'height',
				_1: _user$project$HelloWorld$px(h)
			},
				{
				ctor: '_Tuple2',
				_0: 'width',
				_1: _user$project$HelloWorld$px(w)
			},
				{ctor: '_Tuple2', _0: 'outline', _1: '1px solid black'},
				{
				ctor: '_Tuple2',
				_0: 'pathFromRoot',
				...
				case 'TopRight':
					return {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'top',
							_1: _user$project$HelloWorld$px(0)
						},
						_1: {
							ctor: '_Tuple2',
							_0: 'right',
		...
		return _elm_lang$html$Html_Attributes$style(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ctor: '_Tuple2',
					_0: 'height',
					_1: _user$project$HelloWorld$px(_p1._1)
				},
					{
					ctor: '_Tuple2',
					_0: 'width',
					_1: _user$project$HelloWorld$px(_p1._0)
				}
				]));
	});
var _user$project$HelloWorld$updateDimensions = F3(
	function (clickedCorner, pMouse, mRecord) {
		...
		var dimX = _elm_lang$core$Basics$fst(clickedCorner.initialDim);
		var posY = _elm_lang$core$Basics$snd(clickedCorner.initialPos);
		var posX = _elm_lang$core$Basics$fst(clickedCorner.initialPos);
		var pClicked = clickedCorner.positionClicked;
		...
		switch (_p4.ctor) {
			case 'TopRight':
				return _elm_lang$core$Native_Utils.update(
					mRecord,
					{
						dimensions: {ctor: '_Tuple2', _0: dimX + dx, _1: dimY - dy},
						position: {ctor: '_Tuple2', _0: posX, _1: posY + dy}
					});
			case 'BottomRight':
				return _elm_lang$core$Native_Utils.update(
					mRecord,
					{
						dimensions: {ctor: '_Tuple2', _0: dimX + dx, _1: dimY + dy},
						position: {ctor: '_Tuple2', _0: posX, _1: posY}
					});
			case 'BottomLeft':
				return _elm_lang$core$Native_Utils.update(
					mRecord,
					{
						dimensions: {ctor: '_Tuple2', _0: dimX - dx, _1: dimY + dy},
						position: {ctor: '_Tuple2', _0: posX + dx, _1: posY}
					});
			default:
				return _elm_lang$core$Native_Utils.update(
					mRecord,
					{
						dimensions: {ctor: '_Tuple2', _0: dimX - dx, _1: dimY - dy},
						position: {ctor: '_Tuple2', _0: posX + dx, _1: posY + dy}
					});
		}
	});
var _user$project$HelloWorld$getClickedCorner = function (mRecord) {
	var _p5 = mRecord.controllers;
	if (_p5.ctor === '[]') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
		return _p5._0.clickedCorner;
	}
};
var _user$project$HelloWorld$resizeClicked = F2(
	function (pMouse, mTree) {
		...
		if (_p6.ctor === 'EmptyModel') {
			...
			var _p8 = _p6._0;
			var _p7 = _user$project$HelloWorld$getClickedCorner(_p8);
			if (_p7.ctor === 'Nothing') {
				...
				return _user$project$Types$ModelTree(
					A3(_user$project$HelloWorld$updateDimensions, _p7._0, pMouse, _p8));
			}
		}
	});
	...
	function (pathToDesc, completeTree, newSubTreeFunc) {
		...
		if (_p12.ctor === '[]') {
			...
			var recurseIfMatches = function (subTree) {
				var _p13 = _user$project$Types$getModelRecord(subTree).pathFromRoot;
				if (_p13.ctor === '[]') {
					return subTree;
				} else {
					return _elm_lang$core$Native_Utils.eq(_p13._0, _p12._0) ? A3(_user$project$HelloWorld$modifyDesc, _p12._1, subTree, newSubTreeFunc) : subTree;
				}
			};
...
var _user$project$HelloWorld$addControllerToTree = F2(
	function (pathToDesc, completeTree) {
		return A3(
			_user$project$HelloWorld$modifyDesc,
			_elm_lang$core$List$reverse(pathToDesc),
			completeTree,
			_user$project$HelloWorld$addController);
	});
var _user$project$HelloWorld$deleteControllerFromTree = F2(
	function (pathToDesc, completeTree) {
		return A3(
			_user$project$HelloWorld$modifyDesc,
			_elm_lang$core$List$reverse(pathToDesc),
			completeTree,
			_user$project$HelloWorld$deleteController);
	});
	...
	function (corner, pathToDesc, p, pos, dim, mTree) {
		var toggleClick = F2(
			function (corner, mTree) {
				var _p14 = mTree;
				if (_p14.ctor === 'EmptyModel') {
					return _user$project$Types$EmptyModel;
				} else {
					var _p17 = _p14._0;
					var _p15 = _user$project$HelloWorld$getController(_p17.controllers);
					if (_p15.ctor === 'Nothing') {
						return _user$project$Types$ModelTree(_p17);
					} else {
						var _p16 = _p15._0.clickedCorner;
...
var _user$project$HelloWorld$listRange = function (_p18) {
	return _elm_lang$core$List$reverse(
		_user$project$HelloWorld$listRangeRev(_p18));
};
var _user$project$HelloWorld$modelFromJson = F2(
	function (pathFromRoot, _p19) {
		var _p20 = _p19;
		var _p21 = _p20._0;
		var childrenNodeIds = _user$project$HelloWorld$listRange(
			_elm_lang$core$List$length(_p21.children));
		var children = A3(
			_elm_lang$core$List$map2,
			function (nextId) {
		...
		return _user$project$Types$ModelTree(
			{
				dimensions: _p21.dimensions,
				position: _p21.position,
					...
					switch (_p22.ctor) {
							...
							return {
								...
								_0: function (_p23) {
									return A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[]),
										_user$project$Decoder$decodeJson(_p23));
								}(_p22._0),
						...
						case 'ClickEl':
							if (_p22._1.ctor === 'Nothing') {
								...
								switch (_p22._0.ctor) {
									case 'AddController':
										if (_p22._0._0.ctor === 'Self') {
											return {
												ctor: '_Tuple2',
												_0: A2(_user$project$HelloWorld$addControllerToTree, _p22._1._0, completeModelTree),
												_1: _elm_lang$core$Platform_Cmd$none
											};
										} else {
											break _v15_4;
									...
									case 'DeleteController':
										if (_p22._0._0.ctor === 'Self') {
											return {
												ctor: '_Tuple2',
												_0: A2(_user$project$HelloWorld$deleteControllerFromTree, _p22._1._0, completeModelTree),
												_1: _elm_lang$core$Platform_Cmd$none
											};
										} else {
											break _v15_4;
						...
						case 'ControllerBoxClick':
							if (_p22._2.ctor === 'Just') {
								return {
									ctor: '_Tuple2',
									_0: A6(_user$project$HelloWorld$toggleControllerResizeClick, _p22._0, _p22._2._0, _p22._1, _p22._3, _p22._4, completeModelTree),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							} else {
								return {ctor: '_Tuple2', _0: completeModelTree, _1: _elm_lang$core$Platform_Cmd$none};
						...
						default:
							return {
								ctor: '_Tuple2',
								_0: A2(_user$project$HelloWorld$resizeClicked, _p22._0, completeModelTree),
								_1: _elm_lang$core$Platform_Cmd$none
							};
					}
				} while(false);
...
var _user$project$HelloWorld$init = function (_p24) {
	var _p25 = _p24;
	return A2(
		_user$project$HelloWorld$updateModelTree,
		_user$project$Types$Init(_p25.jsonStr),
	...
	function (pathFromRoot, cmd) {
		return function (_p26) {
			return _user$project$HelloWorld$onClickNoProp(
				_elm_lang$core$Json_Decode$succeed(_p26));
		}(
			A2(
	...
	function (modelRecord, controller) {
		return A2(
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[_user$project$Types$TopRight, _user$project$Types$BottomRight, _user$project$Types$BottomLeft, _user$project$Types$TopLeft])));
	});
var _user$project$HelloWorld$treeToHtml = function (modelTree) {
	var _p27 = modelTree;
	if (_p27.ctor === 'EmptyModel') {
		return _elm_lang$html$Html$text('empty model :(');
	} else {
		var _p28 = _p27._0;
		var children = A2(_elm_lang$core$List$map, _user$project$HelloWorld$treeToHtml, _p28.children);
		var controllers = A2(
			_elm_lang$core$List$map,
			_user$project$HelloWorld$controllerToHtml(_p28),
			_p28.controllers);
		return A2(
			_elm_lang$html$Html$div,
			_user$project$HelloWorld$makeAttributes(_p28),
...
var _user$project$HelloWorld$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$HelloWorld$jsonMessage(_user$project$Types$Init),
				_elm_lang$mouse$Mouse$moves(_user$project$Types$MouseMove)
			]));
};
var _user$project$HelloWorld$program = _elm_lang$html$Html_App$programWithFlags(
	{init: _user$project$HelloWorld$init, update: _user$project$HelloWorld$updateModelTree, subscriptions: _user$project$HelloWorld$subscriptions, view: _user$project$HelloWorld$treeToHtml});
var _user$project$HelloWorld$main = {
	main: _user$project$HelloWorld$program,
	flags: A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'jsonStr', _elm_lang$core$Json_Decode$string),
		function (jsonStr) {
